...
describe("caesar", () => {
  it("should return false if the message is empty or missing or not a string", () => {
    // actual results that come back from calling caesar
    const actualEmptyString = caesar("", 3);
    const actualMissingMessage = caesar();
    const actualMessageNotAString = caesar(65, 3);
